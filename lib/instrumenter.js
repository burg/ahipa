...
(function (isNode) {
    ...
    /**
     * mechanism to instrument code for daikon. It uses the `esprima` and
     ...
     * ---------------
     *
     *      var instrumenter = new require('ahipa').Instrumenter(),
     ...
     * @param {String} [options.globalVariableName] the global variable name to use for
     *      logging. Defaults to `__ahipa__`
    ...
    Instrumenter.prototype = {
        ...
        getPreamble: function (sourceCode) {
            var varName = this.opts.globalVariableName || '__ahipa__',
