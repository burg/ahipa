...
Command.mix(InstrumentCommand, {
    ...
    usage: function () {
        console.error('\nUsage: ' + this.toolName() + ' ' + this.type() + ' <options> <file-or-directory>\n\nOptions are:\n\n' +
            [
                ...
                formatOption('--variable <global-variable-name>', 'change the variable name of the global logger variable from the ' +
                    'default value of `__ahipa__` to something else')
            ].join('\n\n') + '\n');
        console.error('\n');
    },
    ...
    run: function (args, callback) {
        ...
        var config = {
            ...
            stats,
            stream,
            instrumenter = new Instrumenter({ globalVariableName: opts.variable }),
        ...
        instrumenter = new Instrumenter({
            globalVariableName: opts.variable
        });
